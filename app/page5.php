<div class="container" style="background-image: linear-gradient(rgba(15,81,50,.85),rgba(15,81,50,.85)), url('assets/img/properties/Sampuldepan.jpg'); width: 100%; height: 32rem; background-repeat: no-repeat; background-size: cover;">
    <div class="row g-3 mt-3 m-1">
        <div class="col-6 col-lg-3">
            <div class="card align-items-center text-center" style="width: 12rem; height: 12rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Ponpes Al Ankabuut</p>
                    <a href="https://www.facebook.com/share/17q2vr7o5k/" target="_blank" class="btn btn-success">Klik Disini</a>
                </div>
            </div>
        </div>
    <div class="col-6 col-lg-3">
    ...
    <div class="card-body">
        ...
        <p class="card-text">ponpes_alankabuut</p>
        <a href="https://www.instagram.com/ponpes_alankabuut?igsh=am94NHlqMDdiZ2lw" target="_blank" class="btn btn-success">Klik Disini</a>
    </div>
    </div>
    </div>
    <div class="col-6 col-lg-3">
    ...
    <div class="card-body">
        ...
        <p class="card-text">Ponpes Al-Ankabuut</p>
        <a href="https://www.youtube.com/@ponpesal-ankabut7382" target="_blank" class="btn btn-success">Klik Disini</a>
    </div>
    </div>
    </div>
    <div class="col-6 col-lg-3">
    ...
    <div class="card-body">
        ...
        <p class="card-text">Ponpes Al-Ankabuut</p>
        <a href="https://wa.me/6285212319974" target="_blank" class="btn btn-success">Klik Disini</a>
    </div>
    </div>
    </div>
  </div>
